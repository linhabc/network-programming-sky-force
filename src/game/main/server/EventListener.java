...
import game.main.packet.AddPositionPlayerRequestPacket;
...
public class EventListener {
	...
	public void received(Object p, Connection connection) {
		if (p instanceof AddConnectionRequestPacket) {
		...
		else if(p instanceof AddPositionPlayerRequestPacket) {
			AddPositionPlayerRequestPacket packet = (AddPositionPlayerRequestPacket) p;
			...
			ConnectionHandler.handleStartGameRequestPacket(startGameRequestPacket, connection);
		}
	}
